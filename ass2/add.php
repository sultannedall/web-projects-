        ...
        <article>
            ...
            <form method="post" action="add.php" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <p>
                        <label>Product Name (required):</label><br>
                    ...
                    <p>
                        <label>Rating 1-5 (required):</label><br>
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <input type="file" name="photo1" accept="image/jpeg" required>
                    </p>
                    <p>
                        <label>Photo 2:</label><br>
                        <input type="file" name="photo2" accept="image/jpeg" required>
                    </p>
                    <p>
                        <label>Photo 3:</label><br>
                        <input type="file" name="photo3" accept="image/jpeg" required>
                    </p>
                    <p>
                        <label>Default Photo:</label><br>
                        <input type="radio" name="default_photo" value="1" checked> Photo 1
                        <input type="radio" name="default_photo" value="2"> Photo 2
                        <input type="radio" name="default_photo" value="3"> Photo 3
                    </p>
                </fieldset>
                <p>
